...
<div class="min-h-screen text-white p-8 {loading ? 'blur-sm' : ''}">
    ...
    <div class="max-w-3xl mx-auto">
        <div class="mb-8">
            <h1 class="text-4xl font-bold mb-4">Create New Chatbot</h1>
            <p class="text-zinc-400">Design your perfect AI companion by filling out the details below.</p>
        </div>
        ...
        <form onsubmit={handleSubmit} class="space-y-6">
            <div class="space-y-4">
                <div>
                    ...
                    <input
                        ...
                        class="w-full bg-zinc-800/30 border-2 border-white/20 rounded-xl px-4 py-3 text-white placeholder-zinc-500 focus:outline-none focus:border-white/40"
                        required
                    />
                </div>
                ...
                <div>
                    ...
                    <textarea
                        ...
                        class="w-full bg-zinc-800/30 border-2 border-white/20 rounded-xl px-4 py-3 text-white placeholder-zinc-500 focus:outline-none focus:border-white/40 h-24"
                        required
                    ></textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea
                        ...
                        class="w-full bg-zinc-800/30 border-2 border-white/20 rounded-xl px-4 py-3 text-white placeholder-zinc-500 focus:outline-none focus:border-white/40 h-32"
                        required
                    ></textarea>
                </div>
            ...
            <div class="flex justify-end gap-4">
                <a 
                    href="/chats"
                    class="px-6 py-3 rounded-xl bg-zinc-800/30 border-2 border-white/20 text-white hover:bg-zinc-800/50 transition-all duration-200"
                >
                    Cancel
                </a>
                <button
                    type="submit"
                    class="px-6 py-3 rounded-xl bg-white text-black font-medium hover:bg-zinc-200 transition-all duration-200"
                >
                    Create Chatbot
                </button>
            </div>
